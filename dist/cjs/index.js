...
var Table = function (_a) {
    ...
    var _b = React.useState({}), sorting = _b[0], setSorting = _b[1];
    var _c = React.useState(false), allChecked = _c[0], setAllChecked = _c[1];
    var _d = React.useState([]), rowCheckboxes = _d[0], setRowCheckboxes = _d[1];
    var _e = React.useState([]), selectedRows = _e[0], setSelectedRows = _e[1];
...
var Sidebar = function (_a) {
    ...
    var _b = React.useState(1), active = _b[0], setActive = _b[1];
    var _c = React.useState(true), showSide = _c[0], setShowSide = _c[1];
